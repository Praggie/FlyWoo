...
/**
 * 在onActivityResult中返回data,然后data.getStringArrayListExtra(SelectPictureActivity
...
public class AlbumActivity extends Activity {
    ...
    public void showListAnimation() {
        TranslateAnimation ta = new TranslateAnimation(1, -1f, 1, 0f, 1, 0f, 1, 0f);
        ta.setDuration(300);
        listview.startAnimation(ta);
    }

    public void hideListAnimation() {
        TranslateAnimation ta = new TranslateAnimation(1, 0f, 1, -1f, 1, 0f, 1, 0f);
        ta.setDuration(300);
        listview.startAnimation(ta);
